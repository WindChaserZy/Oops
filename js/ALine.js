...
monogatari.script({
    ...
    'A1':[
        ...
        'u （大喊）为什么你们都不能念的对我的名字？我的名字不是就写在身上吗？大家甚至都不愿记住我的名字？不是叫不出我的名字就是直接喊我681？我在人群中就是这样可有可无的存在吗？',
    ...
    'Ab':[
        ...
        '这时你的眼前又突然浮现一串字符：七月悲喜交加 麦浪翻滚 连同草地 直到天涯',
        ...
        '你想为什么会这样？但是既来之则安之，医生既然说没事，那就是没什么事，不要想了不要想了。',
        'jump e8'
    ],
    ...
    'A4':[
        ...
        '低头的时候，你发现，自己开始发光了。',
        'm （原来我也是可以产生能量的）',
        '这时你的眼前又突然浮现一串字符：四月里遍地蔷薇',
        '你下了台，680pF在台下等着和你击掌。你有点不好意思，但是还是伸出手跳起来和他击掌',
        'lbl （神秘兮兮）我来不及啦，我们快点走，我有一场足球赛要踢。',
        '680pF的话好像被旁边的一位同学听到了，他略带不解地皱眉看了一眼680pF，然后摇摇头，接着跟着音乐跳动。那位同学有些厌恶的目光让你感到奇怪。',
        'm 不是要为祖国健康工作五十年吗，踢足球不是很正常？',
        'lbl （不解）你在说什么？咱们的宗旨不是一直是‘为自己快乐躺平一百年’吗？',
        '你坐着680pF的电动车，跟着他来到了北操足球场，只有零零星星几个人在做热身活动，和东操的盛况形成了鲜明的对比。',
    ...
    'A8':[
        ...
        'm 我不会是被击穿了吧，我害怕地想。',
        'doc （微笑）没什么大碍，发光正常，就是光有点微弱，能量不太足，回去给自己多充充电，多休息休息就好了。',
        '你觉得有点奇怪：不太对，我不属于这个世界，本不应该按照这个世界的规则发光的。',
    ...
    'A10':[
        ...
        '其实你有很多次机会可以劝劝他，但是你既然已经说了不认识他，一直没敢和他说话',
        'jump e5'
    ],

    'A11':[
        '你不忍心再听下去，拉着680pF转身离开。走出了一段距离，680pF问你:',
        'lbl 你害怕了？',
        'm （错愕）我怕什么？',
    ...
    'A14':[
        ...
        'lbl 你没有平庸啊，你很优秀！',
        '一直没说话、跟在你旁边把代码看完了的680pF突然大喊。',
        'lbl 幼儿园的时候，老师要画一支向日葵，你画成了彩色的，你信誓旦旦地和老师说，你以后一定会找到五彩的向日葵。你在大一的时候用代码已经把它实现了。',
        'lbl 小学六年级的时候，你被临时叫上台担任晚会主持人，一点都不怯场，圆满地完成了主持任务，大家都夸你以后一定是个优秀的播音员。你在大二的时候创立过一个个人电台，只发过几段配音就放弃了经营。现在已经被网友找到，成为大家的宝藏电台了。',
        'lbl 中学的时候，你开始学习编程。你说想做一个游戏，做成你想要的样子。你在大二的时候做过一个demo去参赛了，但是只走到了初赛就被淘汰了。现在你的demo被学弟学妹们继承了下来，他们继续写了下去，在结尾用大大的字体署了你的名字，向你表达感谢。',
        '680pF疯狂地喊完这一串，楼顶的同学呼了一口气，抹了把眼泪，抓着屋檐坐下了。',
        '你见状，接着喊:',
        '当然你还有很多事情做不好呀，你体育很差，摸鱼学导论学的也不好，也不会打游戏，不会像其他人一样摸的一手好鱼。',
        '但是你一点也不平庸，我们只是在各自的领域闪闪发光。没有人说和大家不一样就是错误的，不应该存在的。有满是摸鱼的世界，也就有满是学习的世界。这个世界错就错在太极端了，它不肯那些不极端的、好好地活在两个极端中间的人活下去。',
        '所以，是世界生病了，不是你。',
        '这时你的眼前又突然浮现一串字符：十一月尚未到来 透过它的窗口 我望见了十二月',
        'jump e1'
    ],
    ...
    'A19':[
        ...
        '他低头看了你一眼，认出了你。',
        'cd 是你啊，你刚才劝我要好好做自己的。',
        'm 你的《王者方舟：原神联盟》玩的也很好，大家都很喜欢和你玩，不是每个人都排挤你，排挤你的人接受不了你的与众不同，那是他们的浅薄，这个世界就应该是包容的！',
        '你身边的同学有做出恍然大悟的表情，你才注意到他们是刚才和你们一起在教学楼玩游戏的那群同学。',
